        ...
        <div class="mr1">
            ...
            <div class="login" id="login">
                <form action="loginAction.jsp" method="post" id="login-form">
                    <input type="text" name="userName" placeholder="아이디" id="userID">
                    <input type="password" name="userPassword" placeholder="비밀번호" id="password">
                    <input type="submit" value="로그인" id="log1">
                </form>
                ...
                <div class="mp4">
                    ...
                    <div class="mp42">
                        <div class="mp421">
                            ...
                            <a class="mp421up" onclick='count("plus")'>
                ...
                <div class="pv10">
                    <div class="pvpv1">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="19" height="5" viewBox="0 0 19 5" fill="none">
                            <rect width="5" height="5" rx="2.5" fill="#C8D2E8"/>
                            <rect x="7" width="5" height="5" rx="2.5" fill="#C8D2E8"/>
                            <rect x="14" width="5" height="5" rx="2.5" fill="#C8D2E8"/>
                        </svg>
                    </div>
                            <div class="submenu_box">
                                <ul class="submenu1">
                                    <li id="bigbox"><a href="#"> 크게 보기</a></li>
                                    <li id="smallbox"><a href="#">작게 보기</a></li>
                                </ul>
                            </div>
